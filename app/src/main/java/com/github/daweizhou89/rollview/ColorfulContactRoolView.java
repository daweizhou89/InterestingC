...
@RemoteView
public class ColorfulContactRoolView extends RollView {
    ...
    private static final int[] RAINBOW_COLOR_LIST = new int[] {
            Color.RED, // red
            Color.rgb(255, 165, 0), // orange
            Color.YELLOW, // yellow
            Color.GREEN, // green
            Color.BLUE, // blue
            Color.rgb(75, 0, 170), // indigo
    ...
    public ColorfulContactRoolView(Context context) {
        this(context, null);
    }
    
    public ColorfulContactRoolView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    
    public ColorfulContactRoolView(Context context, AttributeSet attrs, int style) {
        super(context, attrs, style);
        init();
    }
    
    public void init() {
        mRollController.ENABLE_ROLL_CELL_COLOR = true;
...
//        });
    ...
    class ContactLoadingTask extends AsyncTask<Void, Void, List<ContactItem>> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mTipsIndex = 0;
            ColorfulContactRoolView.this.setNoDataTips(TEXT_LOADING_TIPS[mTipsIndex]);
        ...
        protected void onPostExecute(List<ContactItem> result) {
            ...
            if(result != null) {
                ...
                ColorfulContactRoolView.this.setNoDataTips(TEXT_NOCONTACT_TIPS);
            }
        }
    }
    ...
    class ListTypeRollViewAdapter extends RollViewAdapter {
        ...
        public List<RollCell> bindCells() {
            ...
            int rainbowColorListLength = RAINBOW_COLOR_LIST.length;
            ...
            for (int i = 0; i < rollcellCount; i++) {
                ...
                rollCell.color = RAINBOW_COLOR_LIST[i % rainbowColorListLength];
